...
Lassoing some strokes with finger, a new group is created.  +
And also lassoing some groups ( and some strokes ) with finger, also a new group's group is created.
